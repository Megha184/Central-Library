        ...
        <div class="container">
            <div class="row">
                <table class="table table2" border="1">
                    ...
                    $res=$con->query("select publication_id,thesis_title,subject,thesis_types,date_upload,supervisors,year,date_modify from publication where thesis_types='$thesis_types'");
                        $i=1;
